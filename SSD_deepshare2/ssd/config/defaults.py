...
_C.MODEL.BACKBONE.OUT_CHANNELS = (512, 1024, 512, 256, 256, 256)    # featuremap 维度
...
_C.MODEL.PRIORS.STRIDES = [8, 16, 32, 64, 100, 300]     # 乘以stride回到原来的大小，会有近似计算
# 最大正方形与最小正方形以及之间的一些比例
...
# #boxes = 2 + #ratio * 2
_C.MODEL.PRIORS.BOXES_PER_LOCATION = [4, 6, 6, 6, 4, 4]  # number of boxes per feature map location     #每个特征图有几个box
...
_C.DATA_LOADER.PIN_MEMORY = True    # 加快训练速度
