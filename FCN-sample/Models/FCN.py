...
class FCN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.stage1 = pretrained_net.features[:7]       # 第几层就是几 这里取前六层
        ...
        self.scores1 = nn.Conv2d(512, num_classes, 1)   # 32s 没有复现
        self.scores2 = nn.Conv2d(512, num_classes, 1)   # 16s 没有复现
        self.scores3 = nn.Conv2d(128, num_classes, 1)   # 8s 复现
    ...
    def forward(self, x):       # 352 480 3
        ...
        s5 = self.upsample_2x_1(s5) # 上采样一次     #22 30 512
        add1 = s5 + s4      # 跳跃连接  #直接求和   #22 30 512
        ...
        output = self.conv_trans2(add2)     # 44 66 12
